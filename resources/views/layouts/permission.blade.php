        ...
        <nav class="navbar navbar-expand">
            <div class="container d-flex align-middle justify-content-between">
                ...
                @if (!Request::is('permissions/create*'))
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a href="{{route('permissions.create')}}" class="btn submit-btn">Create New Permission</a>
                        </li>
                    </ul>
                ...
                @else
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a href="{{route('permissions.index')}}" class="btn submit-btn">View All Permissions</a>
                        </li>
                    </ul>
                @endif
            </div>
