            ...
            <div class="card-header bg-white border-bottom-0 p-0">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="solutionForm" role="tabpanel" aria-labelledby="solutionTab" tabindex="0">
                        <form action="{{route('solution.post',['issue_id'=>$issue_id])}}" method="POST" enctype="multipart/form-data">
                            <div class="container p-3">
                                ...
                                <div class="col-md mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" placeholder="add solution here">{{ old('description')}}</textarea>
                                ...
                                <div class="col mb-4 float-end">
                                    <button type="submit" class="btn submit-btn shadow">Create Solution</button>
