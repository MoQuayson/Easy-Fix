...
@section('content')
<form class="container" action="{{route('issues.store')}}" method="POST" enctype="multipart/form-data">
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <div class="">
                ...
                <div class="col-md mb-3">
                    ...
                    <textarea name="description" id="description" class="form-control" placeholder="describe your gadget issue here">{{ old('description') }}</textarea>
        ...
        <div class="card-footer bg-white border-top-0">
            <div class="col mb-1 float-end">
                <button type="submit" class="btn submit-btn shadow">Send Issue</button>
